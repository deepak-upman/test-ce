...
public class SummaryGenerator {
    ...
    public Map<SummaryDTO, Double> generateReport(Map<TransactionEntry, List<Transaction>> transactionsMap) {
        Map<SummaryDTO, Double> summaryReport = new TreeMap<>();
        for (TransactionEntry transactionEntry : transactionsMap.keySet()) {
            for (Transaction transaction : transactionsMap.get(transactionEntry)) {
